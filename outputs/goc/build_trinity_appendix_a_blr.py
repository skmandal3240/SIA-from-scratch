...
OUT = ROOT / "outputs" / "goc" / "TRINITY_Appendix_A_Due_Diligence_Bengaluru.docx"
...
a("Project TRINITY is the vehicle for building India's complete sovereign AI stack — compute, data, models, agents/OS, and applications — delivered through SIA, a family of on-device and cloud AI models. The company is being incorporated as a Private Limited Company in India (SPICe+ filing in progress, registered office: Bengaluru, Karnataka — India's AI talent and venture capital hub). Status: pre-revenue, Seed/pre-Series-A stage. History: from-scratch SIA framework built and trained (nano transformer on CPU), LoRA fine-tune pipeline ready, investor deck and grant dossiers drafted, 5-pillar plan documented.")
...
a("India Private Limited Company (SPICe+ INC-32), registered office in Bengaluru, Karnataka. PAN/TAN auto-issued with CIN. GST registration when revenue begins. DPIIT/Startup India recognition (gates IndiaAI + SAMRIDH + TIDE 2.0). All contracts (employment, IP assignment, NDAs) in place from first hire.")
