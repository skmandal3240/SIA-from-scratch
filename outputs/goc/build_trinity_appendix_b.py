...
OUT = ROOT / "outputs" / "goc" / "TRINITY_Appendix_B_Government_Evaluation.docx"
...
[
    ...
    ("NSE-PRAYAS", "DST", "₹10L", "Grant", "Early prototyping"),
    ...
    ("Bihar Startup Policy", "Govt of Bihar", "varies (ReL=₹25L context)", "Grant/equity", "Patna-registered entity"),
])
...
for item in [
    ...
    "Rural and ESG impact — Bihar pilot + offline/Indic access + clean-energy linkage",
...
[
    ...
    ("Rural/ESG", "3", "Bihar pilot defined"),
